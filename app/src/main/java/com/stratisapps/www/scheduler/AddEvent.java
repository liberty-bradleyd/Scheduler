        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(timeString.isEmpty()){
                    ...
                    Date test = null;
                    try{
                        test = originalFormat.parse(timeString + " " + timeFormat.getText().toString().toLowerCase());
                    ...
                    if(passedFormatTest && timeString.length() <= 5 && timeString.substring(timeString.indexOf(":") + 1, timeString.length()).length() == 2 &&
                        ...
                        try {
                            if(calendar.get(Calendar.AM_PM) == 0){
                                currentDate = originalFormat.parse(String.valueOf(calendar.get(Calendar.HOUR_OF_DAY)) + ":" + String.valueOf(calendar.get(Calendar.MINUTE)) + " am");
                            }
                            else {
                                currentDate = originalFormat.parse(String.valueOf(calendar.get(Calendar.HOUR_OF_DAY)) + ":" + String.valueOf(calendar.get(Calendar.MINUTE)) + " pm");
                            }
